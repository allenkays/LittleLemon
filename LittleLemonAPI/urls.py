...
urlpatterns = [
    ...
    path('groups/manager/users/<int:pk>/', views.ManagerGroupRemoveView.as_view(), name='manager-group-remove'),
    path('groups/delivery-crew/users/', views.DeliveryCrewGroupView.as_view(), name='delivery-crew-group'),
    path('groups/delivery-crew/users/<int:pk>/', views.DeliveryCrewGroupRemoveView.as_view(), name='delivery-crew-group-remove'),
